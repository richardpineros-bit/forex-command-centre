    ...
    function buildSatelliteGrid(p, rowId) {
        ...
        (function() {
            ...
            if (!armedZ && !p.entryZoneActive) {
                ...
                cells.push(cell('ZONE', valueHtml, liveState, tip, 'qual'));
            }
        })();
